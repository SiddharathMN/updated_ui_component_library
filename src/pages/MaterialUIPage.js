  ...
  return (
    <ThemeProvider theme={theme}>
      <Box sx={{ maxWidth: 800, margin: 'auto', padding: 2 }}>
        ...
        {/* Slider */}
        <Card sx={{ mb: 4 , marginTop:"20px"}}>
          <CardContent>
            <Typography variant="h6" gutterBottom>Slider</Typography>
            <Typography variant="body2" color="text.secondary" paragraph>
              Allows user to dynamically select a value from a range.
            </Typography>
            <Box sx={{ width: 300 }}>
            <Slider
              size="small"
        ...
        <Card sx={{ mb: 4 , marginTop:"20px"}}>
          <CardContent>
            <Typography variant="h6" gutterBottom>Custom Slider</Typography>
            <Typography variant="body2" color="text.secondary" paragraph>
              Allows user to dynamically select a value from only selected range and value always visible. 
            </Typography>
            <Box sx={{ width: 300 }}>
              <Slider
